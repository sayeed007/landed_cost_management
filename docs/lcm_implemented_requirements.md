...
- In that mode a **single** unmarked line is also offered, even though there is nothing to consolidate. It still needs adopting: until it carries the marker, every later append adds another line beside it rather than merging. Adopting one leaves its amount untouched and only stamps the category and marker.
