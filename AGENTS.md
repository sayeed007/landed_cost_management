...
- `Repair Vendor Bill Lines` is the only action permitted to edit an already-created Vendor Bill. It is explicit, previewed, confirmed, and total-preserving. Historical transactions must never be mutated silently.
